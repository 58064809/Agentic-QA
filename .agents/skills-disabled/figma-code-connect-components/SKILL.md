...
1. Parse URL: fileKey=`figma-file-key`, nodeId=`42-15` → convert to `42:15`
2. Run `get_code_connect_suggestions(fileKey="figma-file-key", nodeId="42:15")`
...
9. Run `send_code_connect_mappings(fileKey="figma-file-key", nodeId="42:15", mappings=[{ nodeId: "42:15", componentName: "Button", source: "src/components/Button.tsx", label: "React" }])`
...
1. Parse URL: fileKey=`figma-file-key`, nodeId=`10-50` → convert to `10:50`
2. Run `get_code_connect_suggestions(fileKey="figma-file-key", nodeId="10:50")`
...
7. Run `send_code_connect_mappings(fileKey="figma-file-key", nodeId="10:50", mappings=[{ nodeId: "10:51", componentName: "ProductCard", source: "src/components/ProductCard.tsx", label: "React" }])`
...
1. Parse URL: fileKey=`figma-file-key`, nodeId=`5-20` → convert to `5:20`
2. Run `get_code_connect_suggestions(fileKey="figma-file-key", nodeId="5:20")`
...
9. Run `send_code_connect_mappings(fileKey="figma-file-key", nodeId="5:20", mappings=[{ nodeId: "5:20", componentName: "CheckIcon", source: "src/icons/CheckIcon.tsx", label: "React" }])`
